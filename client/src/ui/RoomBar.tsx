...
import { LEADERBOARDS_URL, goToRoom, navigate } from '../router';
  ...
  return (
    <div className="roombar">
      ...
      <div className="tray roombar__nav">
        ...
        <button className="hud__btn" onClick={() => void navigate(LEADERBOARDS_URL)} aria-label="leaderboards" title="Ranking">
          <Icon name="trophy" />
        </button>
