...
class ParticleContainerPipe {
  ...
  execute(container) {
    ...
    state.blendMode = getAdjustedBlendModeBlend.getAdjustedBlendModeBlend(container.groupBlendMode, container.texture._source);
    ...
    const bgr = multiplyHexColors.multiplyHexColors(groupColorAlpha & 16777215, worldColorAlpha & 16777215);
