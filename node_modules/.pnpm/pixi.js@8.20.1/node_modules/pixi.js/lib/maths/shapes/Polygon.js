...
var getOrientationOfPoints = require('../misc/getOrientationOfPoints.js');
...
class Polygon {
  ...
  strokeContains(x, y, strokeWidth, alignment = 0.5) {
    const { points } = this;
    const alignedByWinding = alignment === 0.5 ? alignment : (alignment - 0.5) * getOrientationOfPoints.getOrientationOfPoints(points) + 0.5;
