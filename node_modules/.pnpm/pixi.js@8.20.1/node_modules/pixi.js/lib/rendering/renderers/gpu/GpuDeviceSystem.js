...
class GpuDeviceSystem {
  ...
  async _createDeviceAndAdaptor(options) {
    ...
    const device = await adapter$1.requestDevice({
      requiredFeatures,
      requiredLimits: {
        maxSampledTexturesPerShaderStage: adapter$1.limits.maxSampledTexturesPerShaderStage,
        maxSamplersPerShaderStage: adapter$1.limits.maxSamplersPerShaderStage
      }
    });
