 ...
 * @advanced
 */
export type TextureResourceOrOptions = ImageResource | TextureSourceOptions<ImageResource> | BufferSourceOptions | CanvasSourceOptions | PixiMixins.TextureSourceResources[keyof PixiMixins.TextureSourceResources];
/**
 * @param options
