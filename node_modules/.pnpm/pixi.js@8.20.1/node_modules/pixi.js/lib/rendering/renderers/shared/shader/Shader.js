...
var ShaderOverrides = require('./ShaderOverrides.js');
...
class Shader extends EventEmitter {
  constructor(options) {
    ...
    this._overrides = overrides ? ShaderOverrides.ShaderOverrides.from(overrides) : null;
    ...
    if (resources && groups) {
      ...
      for (const i in resources) {
        ...
        if (gpuProgram && !glProgram) {
          warn.warn(`[Shader] the resource '${i}' matches no binding in the WGSL source \u2014 is the name correct?`);
        }
        if (!groups[99]) {
